...
export default function OmnifoodWidget({
  ...
  const projectData = {
    ...
    gallery: [
      "src/assets/images/omnifood-gallery-1.png",
      "src/assets/images/omnifood-gallery-2.png",
      "src/assets/images/omnifood-gallery-3.png",
    ],
  ...
  return (
    <div className="widget-wrapper item-fade-in">
      ...
      >
        ...
        <img
          src="src/assets/images/omnifood-widget-image.png"
          className="omnifood-widget-image"
        ></img>
      </div>
    </div>
  );
